package com.footballfan.gateway.util;

import com.footballfan.gateway.application.domain.vo.JwtTokenVO;
...
import static com.footballfan.gateway.adapter.in.web.response.ErrorCode.INVALID_TOKEN;
...
public class JwtProvider {
    ...
    public boolean validateToken(String token) throws TokenException, SignatureException, ExpiredJwtException {
