package com.football_fan.coupon_event.application.service;
...
public class RedisService {
    ...
    private static final TimeUnit WAIT_FOR = TimeUnit.SECONDS;
    ...
    public boolean acquireLock(String key) {
        ...
        try {
            acquired = lock.tryLock(WAIT_TIME, LEASE_TIME, WAIT_FOR);
